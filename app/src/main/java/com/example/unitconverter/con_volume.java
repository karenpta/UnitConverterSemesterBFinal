...
public class con_volume extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenshot=new Screenshot(con_volume.this);
            ...
            public void onClick(View view) {
                ...
                screenshot.setCallback(new Screenshot.OnResultListener() {
                    ...
                    public void result(boolean success, String filePath, Bitmap bitmap) {
                        if(success){
                            Toast.makeText(con_volume.this, "Uploading Screenshot...", Toast.LENGTH_SHORT).show();
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(con_volume.this);
