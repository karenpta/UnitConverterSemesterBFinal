...
public class con_speed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenshot=new Screenshot(con_speed.this);
            ...
            public void onClick(View view) {
                ...
                screenshot.setCallback(new Screenshot.OnResultListener() {
                    ...
                    public void result(boolean success, String filePath, Bitmap bitmap) {
                        if(success){
                            Toast.makeText(con_speed.this, "Uploading Screenshot...", Toast.LENGTH_SHORT).show();
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(con_speed.this);
